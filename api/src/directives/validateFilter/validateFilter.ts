...
import { getSubFilterExpressions, hasSubFilterExpressions } from "src/lib/filters/filters";
...
export const schema = gql`
  ...
  """
  directive @validateFilter(tables: [String!]!, max_depth: Int=4) on FIELD_DEFINITION
`;
